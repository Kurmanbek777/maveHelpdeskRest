...
import com.test.mavehelpdeskrest.util.JsfUtil;
import com.test.mavehelpdeskrest.util.PaginationHelper;
...
public class DepartmentController implements Serializable {
    ...
    @EJB
    private com.test.mavehelpdeskrest.DepartmentFacade ejbFacade;
